...
FIXED in 09f1a88: Store.resolve refuses the lone-central-project fallback inside a git work tree (directing the user to `continuity init` instead), and central mode now states outright in resume that its state will not reach anyone who clones.
