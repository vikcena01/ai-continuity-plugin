...
Everything is approved and ready. `main` was at the pre-attribution-rewrite tip (hash intentionally not quoted - a current-tip hash is stale the moment it is written, and is invalidated outright by any rewrite), tag v1.0.0, tree clean, 69 assertions green, dist/ verified in sync, and origin still shows 0 refs — nothing has been published.
