...
FIXED in 09f1a88: resume now reports the count of captured commits not on the upstream, and stays silent when there is no upstream. Deliberately NOT auto-push — that would be an outbound action nobody asked for.
