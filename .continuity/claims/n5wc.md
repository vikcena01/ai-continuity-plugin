...
tags: []
superseded_reason: >-
  All three items the superseded next_action listed are done locally (remote
  wired, install command fixed, stray file deleted); the only remaining step is
  the outward-facing push, which is being held for the user's explicit go-ahead.
---
